...
const Input = React.forwardRef(({
  ...
  const baseInputClasses = `
    ...
    ${error ? 'border-[#f44444] focus-visible:ring-[#f44444]' : 'border-[#cbced6] focus:border-[#00bfa6]'}
    ${disabled ? 'bg-[#f5f5f5] text-[#999999] border-[#e0e0e0] cursor-not-allowed' : 'text-[#333333]'}
